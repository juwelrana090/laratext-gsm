        ...
        <div class="col-lg-4 col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="brand">
                        <div class="brandIcon">
                            <img id="imagePreview" src="<?php echo e(asset('images/audi.png')); ?>" alt="" srcset="">
                        </div>
                        <div class="brandName">
                            <p>Name</p>
                        </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-lg-8 col-md-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body" style="position: relative;">
                        <?php echo $__env->make('backend.brands.brand_list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\app_gsp\resources\views\backend\brands\index.blade.php ENDPATH**/ ?>