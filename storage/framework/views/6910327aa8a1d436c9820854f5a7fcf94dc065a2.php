            ...
            <div class="card" style="background-color: #fde4e477">
                ...
                <div class="card-content">
                    <div class="card-body" style="position: relative;">
                        <div class="row">
                            <div class="col-12">
                                <form action="<?php echo e(route('experts.category.update', $category->id)); ?>" method="post"
...
<?php echo $__env->make('layouts.backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\app_gsp\resources\views\backend\experts\categories\categories_edit.blade.php ENDPATH**/ ?>