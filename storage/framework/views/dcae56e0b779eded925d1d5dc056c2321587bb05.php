...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo e(asset('Backend/app-assets/images/ico/apple-icon-120.png')); ?>">
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('Backend/app-assets/images/ico/favicon.ico')); ?>">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('Backend/app-assets/css/pages/authentication.css')); ?>">
    <!-- END: Page CSS-->
...
<?php /**PATH C:\laragon\www\app_gsp\resources\views/layouts/backend/auth_master.blade.php ENDPATH**/ ?>