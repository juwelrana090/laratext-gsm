    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="<?php echo e($carSetupActive ? 'sidebar-group-active open' : ''); ?>  nav-item">
                ...
                <ul class="menu-content">
                    <li class="<?php echo e(Route::is('blogs.create') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('blogs.create')); ?>"><i class="feather icon-circle"></i><span
                                class="menu-item" data-i18n="Alerts">Blog Add</span></a>
                    </li>
                    <li class="<?php echo e(Route::is('blogs.index') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('blogs.index')); ?>"><i class="feather icon-circle"></i><span class="menu-item"
                                data-i18n="Alerts">Blog List</span></a>
                    </li>
                    <li class="<?php echo e(Route::is('blogs.category.index') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('blogs.category.index')); ?>"><i class="feather icon-circle"></i><span
            ...
            <li class=" <?php echo e(Route::is('touch.index') ? 'active' : ''); ?> nav-item">
                <a href="<?php echo e(route('touch.index')); ?>">
                    <i class="fa fa-star-half-o"></i>
                    <span class="menu-title" data-i18n="Dashboard">Get In Touch List</span>
                </a>
            </li>

            <li class=" <?php echo e(Route::is('review.index') ? 'active' : ''); ?> nav-item">
            ...
            <li class=" <?php echo e(Route::is('banner.index') ? 'active' : ''); ?> nav-item"><a
                    href="<?php echo e(route('banner.index')); ?>"><i class="feather icon-zap"></i><span class="menu-title"
