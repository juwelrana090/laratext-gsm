                                    ...
                                    <div class="row g-0">
                                        <div class="col-4 p-2">
                                            <img src="<?php echo e(asset($images[0]->image_path)); ?>"
                                                ...
                                                alt="<?php echo e($item->company_name); ?>" title="<?php echo e($item->company_name); ?>"
                                                style="height: 65px;">
                                        </div>
                                        <div class="col-8">
                ...
                <div class="col-12 col-md-8 col-lg-9">
                    <div class="row row-cols-1 g-4">
                        ...
                        <?php $__currentLoopData = $businesses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $images = json_decode($item->business_images); ?>
                            <div class="col">
                                <div class="card border-0" style="background-color: #cfcfcf4f">
                                    <div class="row g-0">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="card-body">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    ...
                                                    <li
                                                        class="list-group-item d-flex justify-content-between align-items-center px-0" style="background-color: #ffffff00 !important;">
                                                        <div class="fw-semibold">
                                                            <i class="bi bi-envelope-at-fill me-1"></i>
                                                            <small>Email</small>
                                                        </div>
                                                        <div>
                                                            <small><?php echo e($item->company_email); ?></small>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li
                                                        ...
                                                        <div>
                                                            <small<?php echo e($item->website); ?>< /small>
                                                        </div>
                                                    </li>
