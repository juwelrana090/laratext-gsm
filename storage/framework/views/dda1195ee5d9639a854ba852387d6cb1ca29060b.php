                    ...
                    <div class="card-content">
                        <div class="card-body" style="position: relative;">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" onkeyup="convertToSlug(this.value)" name="title" value="<?php echo e($car->title); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="slug" value="<?php echo e($car->slug); ?>" class="form-control" id="title_slug"
                                        placeholder="Slug">
                                </div>
                            </div>
                            ...
                            <div class="form-group mt-1">
                                ...
                                <textarea name="general_dsc" class="form-control ckeditor" id="exampleFormControlTextarea1"
                                    rows="3"><?php echo e($car->general_dsc); ?></textarea>
                            </div>
                            <hr>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input name="category" type="text" class="form-control" id="category"
                                        placeholder="Category" value="<?php echo e($car->category); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="sub_category" class="form-control datepicker-2" id="sub_category"
                                        placeholder="Sub Category" value="<?php echo e($car->sub_category); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input name="payment_options" type="text" class="form-control" id="payment_options"
                                        placeholder="Payment Options" value="<?php echo e($car->payment_options); ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-content">
                        <div class="card-body" style="position: relative;">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="seo_title" class="form-control <?php $__errorArgs = ['seo_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="seo_title" placeholder="SEO Title" value="<?php echo e($car->seo_title); ?>">
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="seo_keywords" class="form-control <?php $__errorArgs = ['seo_keywords'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="seo_keywords" placeholder="SEO Keywords" value="<?php echo e($car->seo_keywords); ?>">
                                </div>
