        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body" style="position: relative;">
                    <div class="row">
                        <div class="col-12">
                            <?php if($UserAccess->can('role.create')): ?>
...
unset($__errorArgs, $__bag); ?>" name="name" placeholder="Role Name">
                                                ...
                                                <?php $__currentLoopData = $permission_groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <div class="row mb-1">
                                                        <div class="col-4">
                                                            <fieldset>
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input" value="<?php echo e($group->group_name); ?>"  id="assignAllGroupPermissions<?php echo e($i); ?>" onclick="checkPermissionByGroup('role-<?php echo e($i); ?>-management-checkbox',this)">
                                                        ...
                                                        <div class="col-8 role-<?php echo e($i); ?>-management-checkbox">
                                                            <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <fieldset>
                                                                    <div class="custom-control custom-checkbox">
                                                                        <input type="checkbox" name="permissions[]" class="custom-control-input"  value="<?php echo e($permission->name); ?>" name="name" id="customCheck<?php echo e($permission->id); ?>">
...
<?php echo $__env->make('layouts.backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\app_gsp\resources\views\backend\role\index.blade.php ENDPATH**/ ?>