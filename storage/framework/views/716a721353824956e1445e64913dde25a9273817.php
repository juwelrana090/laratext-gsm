                ...
                <div class="row g-0">
                  <div class="col-md-4 p-2">
                    <div class="img-container rounded">
                      <img src="<?php echo e(asset('images/person1.png')); ?>" class="img-fluid rounded d-block m-auto" alt="..." title="..." style="width: auto; height: 235px;">
                    </div>
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
            ...
            <div class="col">
              <div class="card expert-list border-0">
                <div class="row g-0">
                  <div class="col-md-4 p-2">
                    <div class="img-container rounded">
                      <img src="<?php echo e(asset('images/person2.png')); ?>" class="img-fluid rounded d-block m-auto" alt="..." title="..." style="width: auto; height: 235px;">
                    </div>
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
            ...
            <div class="col">
              <div class="card expert-list border-0">
                <div class="row g-0">
                  <div class="col-md-4 p-2">
                    <div class="img-container rounded">
                      <img src="<?php echo e(asset('images/person3.png')); ?>" class="img-fluid rounded d-block m-auto" alt="..." title="..." style="width: auto; height: 235px;">
                    </div>
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
            ...
            <div class="col">
              <div class="card expert-list border-0">
                <div class="row g-0">
                  <div class="col-md-4 p-2">
                    <div class="img-container rounded">
                      <img src="<?php echo e(asset('images/person4.png')); ?>" class="img-fluid rounded d-block m-auto" alt="..." title="..." style="width: auto; height: 235px;">
                    </div>
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
            ...
            <div class="col">
              <div class="card expert-list border-0">
                <div class="row g-0">
                  <div class="col-md-4 p-2">
                    <div class="img-container rounded">
                      <img src="<?php echo e(asset('images/person5.png')); ?>" class="img-fluid rounded d-block m-auto" alt="..." title="..." style="width: auto; height: 235px;">
                    </div>
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
            ...
            <div class="col">
              <div class="card expert-list border-0">
                <div class="row g-0">
                  <div class="col-md-4 p-2">
                    <div class="img-container rounded">
                      <img src="<?php echo e(asset('images/person6.png')); ?>" class="img-fluid rounded d-block m-auto" alt="..." title="..." style="width: auto; height: 235px;">
                    </div>
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
            ...
            <div class="col">
              <div class="card expert-list border-0">
                <div class="row g-0">
                  <div class="col-md-4 p-2">
                    <div class="img-container rounded">
                      <img src="<?php echo e(asset('images/person9.png')); ?>" class="img-fluid rounded d-block m-auto" alt="..." title="..." style="width: auto; height: 235px;">
                    </div>
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
