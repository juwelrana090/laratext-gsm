<?php $__env->startSection('title'); ?>
    <title>Brand List | GSP - The best place to explore your favourite business.</title>
                    ...
                    <div class="card category-card border-0">
                        <div class="card-body p-0 mb-3">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="fw-semibold py-2 px-3 rounded-3" style="font-size: 1.2rem;">Brand List</span>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\app_gsp\resources\views/brand/index.blade.php ENDPATH**/ ?>