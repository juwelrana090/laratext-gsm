...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('experts.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="row">
...
unset($__errorArgs, $__bag); ?>" id="mobile"
                                        placeholder="Mobile" value="<?php echo e(old('mobile')); ?>">
                                </div>
...
unset($__errorArgs, $__bag); ?>"
                                        id="whatsapp_number" placeholder="WhatsApp" value="<?php echo e(old('whatsapp_number')); ?>">
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row">
                                <label for="about" class="col-sm-2 col-form-label">About <span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="about" id="about" rows="3"><?php echo e(old('about')); ?></textarea>
                                </div>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e(old('starting_prices')); ?>">
                                </div>
...
unset($__errorArgs, $__bag); ?>" id="google_map"
                                        placeholder="Contact Google Map" value="<?php echo e(old('google_map')); ?>">
                                </div>
...
unset($__errorArgs, $__bag); ?>" id="website"
                                        placeholder="Website" value="<?php echo e(old('website')); ?>">
                                </div>
...
unset($__errorArgs, $__bag); ?>" id="seo_title"
                                        placeholder="SEO Title" value="<?php echo e(old('seo_title')); ?>">
                                </div>
...
unset($__errorArgs, $__bag); ?>"
                                        id="seo_keywords" placeholder="SEO Keywords" value="<?php echo e(old('seo_keywords')); ?>">
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="seo_description" id="seo_description" rows="3"
                                        ...
                                        <?php echo e(old('seo_description')); ?>
...
<?php echo $__env->make('layouts.backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\app_gsp\resources\views/backend/experts/experts_add.blade.php ENDPATH**/ ?>