...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e($business->business_type); ?>">
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="status" class="form-control select2" id="status">
                                        <option value="active" <?php if($business->status == 'active'): ?> selected <?php endif; ?>>Active</option>
                                        <option value="pending" <?php if($business->status == 'pending'): ?> selected <?php endif; ?>>Pending</option>
                                        <option value="inactive" <?php if($business->status == 'inactive'): ?> selected <?php endif; ?>>Inactive</option>
                                        <option value="rejected" <?php if($business->status == 'rejected'): ?> selected <?php endif; ?>>Rejected</option>
                                    </select>
                                </div>
                            </div>
