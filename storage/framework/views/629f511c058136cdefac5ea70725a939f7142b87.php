<?php $__env->startSection('title', 'Locations edit'); ?>
            ...
            <div class="card" style="background-color: #fde4e477">
                ...
                <div class="card-content">
                    <div class="card-body" style="position: relative;">
                        <div class="row">
                            <div class="col-12">
                                <form action="<?php echo e(route('locations.update', $locations_info->id)); ?>" method="post"
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e($locations_info->title); ?>" name="title"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="description" id="categoryDsc" rows="3"><?php echo e($locations_info->description); ?></textarea>
                                    </div>
...
unset($__errorArgs, $__bag); ?>" id="seo_title"
                                                placeholder="SEO Title" value="<?php echo e($locations_info->meta_title); ?>">
                                        </div>
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                value="<?php echo e($locations_info->meta_keywords); ?>">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea class="form-control" name="seo_description" id="seo_description" rows="3" placeholder="SEO Description">
                                                <?php echo e($locations_info->meta_description); ?>
...
<?php echo $__env->make('layouts.backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\app_gsp\resources\views/backend/locations/edit.blade.php ENDPATH**/ ?>