                                ...
                                <div class="col-md-4 p-2">
                                    <div class="img-container rounded">
                                        <img src="<?php echo e(thumbnail($car->CarImage[0]->image)); ?>"
                                            class="img-fluid rounded d-block m-auto" alt="<?php echo e($car->title); ?>" title="<?php echo e($car->title); ?>"
                                        ...
                                        <div class="row g-2">
                                            <div class="col-sm-12 col-md-8 col-lg-9 text-truncate">
                                                <i class="bi bi-geo-alt-fill" style="color: var(--sky-blue);">
                                                    <small class="fw-semibold text-muted"><?php echo e($car->pub_place); ?></small>
                                                </i>
                                            </div>
