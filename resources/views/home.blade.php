            ...
            <div class="row row-cols-2 row-cols-md-4 row-cols-md-6 g-3">
                <div class="col">
                    <div class="card category-list-card border- py-2" style="width: 100%">
                        <img class="card-img-top d-block m-auto" src="./images/technology.png') }}" alt="..." title="..."
                            style="width: 3rem; height: 3rem" />
                        <div class="card-body text-truncate py-2">
                            <h6 class="card-title fw-semibold text-center my-0" style="font-size: 1rem">Auto Spare Parts
                            </h6>
                ...
                <div class="col">
                    <div class="card category-list-card border- py-2" style="width: 100%">
                        <img class="card-img-top d-block m-auto" src="./images/technology.png') }}" alt="..." title="..."
                            style="width: 3rem; height: 3rem" />
                        <div class="card-body text-truncate py-2">
                            <h6 class="card-title fw-semibold text-center my-0" style="font-size: 1rem">Hardware & Tools
                            </h6>
                            <a href="#" class="stretched-link"></a>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card category-list-card border- py-2" style="width: 100%">
                        <img class="card-img-top d-block m-auto" src="./images/technology.png') }}" alt="..." title="..."
                            style="width: 3rem; height: 3rem" />
                        <div class="card-body text-truncate py-2">
                            <h6 class="card-title fw-semibold text-center my-0" style="font-size: 1rem">Electronics Part
                            </h6>
                            <a href="#" class="stretched-link"></a>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card category-list-card border- py-2" style="width: 100%">
                        <img class="card-img-top d-block m-auto" src="./images/technology.png') }}" alt="..." title="..."
                            style="width: 3rem; height: 3rem" />
                        <div class="card-body text-truncate py-2">
                            <h6 class="card-title fw-semibold text-center my-0" style="font-size: 1rem">Industrial Parts
                            </h6>
                            <a href="#" class="stretched-link"></a>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card category-list-card border- py-2" style="width: 100%">
                        <img class="card-img-top d-block m-auto" src="./images/technology.png') }}" alt="..." title="..."
                            style="width: 3rem; height: 3rem" />
                        <div class="card-body text-truncate py-2">
                            <h6 class="card-title fw-semibold text-center my-0" style="font-size: 1rem">Safety & Secuirity
                            </h6>
                            <a href="#" class="stretched-link"></a>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card category-list-card border- py-2" style="width: 100%">
                        <img class="card-img-top d-block m-auto" src="./images/technology.png') }}" alt="..."
                            title="..." style="width: 3rem; height: 3rem" />
                        <div class="card-body text-truncate py-2">
                            <h6 class="card-title fw-semibold text-center my-0" style="font-size: 1rem">Mobile & Computer
                            </h6>
                            <a href="#" class="stretched-link"></a>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card category-list-card border- py-2" style="width: 100%">
                        <img class="card-img-top d-block m-auto" src="./images/technology.png') }}" alt="..."
                            title="..." style="width: 3rem; height: 3rem" />
                        <div class="card-body text-truncate py-2">
                            <h6 class="card-title fw-semibold text-center my-0" style="font-size: 1rem">office Equipment
                            </h6>
                            <a href="#" class="stretched-link"></a>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card category-list-card border- py-2" style="width: 100%">
                        <img class="card-img-top d-block m-auto" src="./images/technology.png') }}" alt="..."
                            title="..." style="width: 3rem; height: 3rem" />
                        <div class="card-body text-truncate py-2">
                            <h6 class="card-title fw-semibold text-center my-0" style="font-size: 1rem">Truck Parts</h6>
                            <a href="#" class="stretched-link"></a>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card category-list-card border- py-2" style="width: 100%">
                        <img class="card-img-top d-block m-auto" src="./images/technology.png') }}" alt="..."
                            title="..." style="width: 3rem; height: 3rem" />
                        <div class="card-body text-truncate py-2">
                            <h6 class="card-title fw-semibold text-center my-0" style="font-size: 1rem">Electronics parts
                            </h6>
                            <a href="#" class="stretched-link"></a>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card category-list-card border- py-2" style="width: 100%">
                        <img class="card-img-top d-block m-auto" src="./images/technology.png') }}" alt="..."
                            title="..." style="width: 3rem; height: 3rem" />
                        <div class="card-body text-truncate py-2">
                            <h6 class="card-title fw-semibold text-center my-0" style="font-size: 1rem">Bike Parts</h6>
                            <a href="#" class="stretched-link"></a>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card category-list-card border- py-2" style="width: 100%">
                        <img class="card-img-top d-block m-auto" src="./images/technology.png') }}" alt="..."
                            title="..." style="width: 3rem; height: 3rem" />
                        <div class="card-body text-truncate py-2">
                            <h6 class="card-title fw-semibold text-center my-0" style="font-size: 1rem">Yachts Parts</h6>
                            <a href="#" class="stretched-link"></a>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card category-list-card border- py-2" style="width: 100%">
                        <img class="card-img-top d-block m-auto" src="./images/technology.png') }}" alt="..."
                            title="..." style="width: 3rem; height: 3rem" />
                        <div class="card-body text-truncate py-2">
                            <h6 class="card-title fw-semibold text-center my-0" style="font-size: 1rem">Hardware and Tools
                            </h6>
                            <a href="#" class="stretched-link"></a>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card category-list-card border- py-2" style="width: 100%">
                        <img class="card-img-top d-block m-auto" src="./images/technology.png') }}" alt="..."
                            title="..." style="width: 3rem; height: 3rem" />
                        <div class="card-body text-truncate py-2">
                            <h6 class="card-title fw-semibold text-center my-0" style="font-size: 1rem">Machine Parts</h6>
                            <a href="#" class="stretched-link"></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="card category-list-card border- py-2" style="width: 100%">
                        <img class="card-img-top d-block m-auto" src="./images/technology.png') }}" alt="..."
                            title="..." style="width: 3rem; height: 3rem" />
                        <div class="card-body text-truncate py-2">
                            <h6 class="card-title fw-semibold text-center my-0" style="font-size: 1rem">Mitshubisini</h6>
                            <a href="#" class="stretched-link"></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="card category-list-card border- py-2" style="width: 100%">
                        <img class="card-img-top d-block m-auto" src="./images/technology.png') }}" alt="..."
                            title="..." style="width: 3rem; height: 3rem" />
                        <div class="card-body text-truncate py-2">
                            <h6 class="card-title fw-semibold text-center my-0" style="font-size: 1rem">Infinity</h6>
                            <a href="#" class="stretched-link"></a>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card category-list-card border- py-2" style="width: 100%">
                        <img class="card-img-top d-block m-auto" src="./images/technology.png') }}" alt="..."
                            title="..." style="width: 3rem; height: 3rem" />
                        <div class="card-body text-truncate py-2">
                            <h6 class="card-title fw-semibold text-center my-0" style="font-size: 1rem">Land Rover</h6>
                            <a href="#" class="stretched-link"></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="card category-list-card border- py-2" style="width: 100%">
                        <img class="card-img-top d-block m-auto" src="./images/technology.png') }}" alt="..."
                            title="..." style="width: 3rem; height: 3rem" />
                        <div class="card-body text-truncate py-2">
                            <h6 class="card-title fw-semibold text-center my-0" style="font-size: 1rem">Rchevrolet</h6>
                            <a href="#" class="stretched-link"></a>
                        </div>
                    </div>
                </div>
