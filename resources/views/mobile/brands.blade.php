...
@section('content')
    ...
    <div class="container" style="min-height: 80vh">
        <div class="card_section_title mt-5 text-uppercase" style="font-weight: bold;font-size: 20px;">
            Manufacturer Brands
        </div>
        <hr>
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="blog-item" style="margin-bottom: 50px;">
                    <div class="blog-img img-hover-effect" style="border: 1px solid #dee2e6;display: flex;align-items: center;justify-content: center;">
