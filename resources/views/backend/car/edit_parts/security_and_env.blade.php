...
<div class="row">
    <div class="col-lg-6">
        <div class="form-check">
            <input class="form-check-input" {{ $fourWd ? 'checked' : '' }} name="security_env[]" type="checkbox" value="4WD"
                id="4wd">
        ...
        <div class="form-check">
            <input class="form-check-input" {{ $adapTiveCruise ? 'checked' : '' }} type="checkbox" name="security_env[]"
        ...
        <div class="form-check">
            <input class="form-check-input"  {{ $airbags_front_side ? 'checked' : '' }} type="checkbox" name="security_env[]"
        ...
        <div class="form-check">
            <input class="form-check-input"  {{ $Differential_lock ? 'checked' : '' }} type="checkbox" name="security_env[]"
        ...
        <div class="form-check">
            <input class="form-check-input"  {{ $Lane_departure_alert ? 'checked' : '' }} type="checkbox" name="security_env[]"
        ...
        <div class="form-check">
            <input class="form-check-input"  {{ $Parking_assist ? 'checked' : '' }} name="security_env[]" type="checkbox"
        ...
        <div class="form-check">
            <input class="form-check-input"  {{ $Rear_wheel_drive ? 'checked' : '' }} name="security_env[]" type="checkbox"
        ...
        <div class="form-check">
            <input class="form-check-input"  {{ $Traction_control ? 'checked' : '' }} name="security_env[]" type="checkbox"
        ...
        <div class="form-check">
            <input class="form-check-input"  {{ $Xenon_headlights ? 'checked' : '' }} name="security_env[]" type="checkbox"
    ...
    <div class="col-lg-6">
        <div class="form-check">
            <input class="form-check-input"  {{ $ABS ? 'checked' : '' }} name="security_env[]" type="checkbox" value="ABS"
                id="abs">
        ...
        <div class="form-check">
            <input class="form-check-input"  {{ $Adaptive_lighting ? 'checked' : '' }} name="security_env[]" type="checkbox"
        ...
        <div class="form-check">
            <input class="form-check-input"  {{ $All_wheel_drive ? 'checked' : '' }} name="security_env[]" type="checkbox"
        ...
        <div class="form-check">
            <input class="form-check-input"  {{ $Front_wheel_drive ? 'checked' : '' }} name="security_env[]" type="checkbox"
        ...
        <div class="form-check">
            <input class="form-check-input"  {{ $LED_headlight ? 'checked' : '' }} name="security_env[]" type="checkbox"
        ...
        <div class="form-check">
            <input class="form-check-input"  {{ $tyre_pressure ? 'checked' : '' }} name="security_env[]" type="checkbox"
