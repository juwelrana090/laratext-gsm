                                ...
                                <form action="{{ route('admin.social.whatsApp.update') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="first-name-vertical" class="form-control"
                                            value="{{ $socialLInk->fb }}" name="fb" placeholder="Facebook Link">
                                    </div>

                                    <div class="form-group">
                                        <label for="first-name-vertical">Instagram</label>
                                        <input type="text" id="first-name-vertical" class="form-control"
                                            value="{{ $socialLInk->instagram }}" name="instagram"
                                            placeholder="Instagram Link">
                                    </div>
                                    <div class="form-group">
                                        <label for="first-name-vertical">Twitter</label>
                                        <input type="text" id="first-name-vertical" class="form-control"
                                            value="{{ $socialLInk->twitter }}" name="twitter" placeholder="Twitter Link">
                                    </div>
                                    <div class="form-group">
                                        <label for="first-name-vertical">Youtube</label>
                                        <input type="text" id="first-name-vertical" class="form-control"
                                            value="{{ $socialLInk->youtube }}" name="youtube" placeholder="Youtube Link">
                                    </div>
                                    <div class="form-group">
                                        <label for="first-name-vertical">WhatsApp Number</label>
                                        <input type="text" id="first-name-vertical" class="form-control"
                                            value="{{ $socialLInk->whatsApp }}" name="whatsApp"
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body" style="position: relative;">
                                <div class="row">
                                    <div class="col-12">
                                        <form action="{{ route('admin.setting.office.location_update', 'dubai') }}"
                                            method="post">
                                            @csrf
                                            <div class="form-group">
                                                <label for="first-name-vertical">TEL</label>
                                                <input type="text" id="first-name-vertical" class="form-control"
                                                    value="{{ dubai_address() ? dubai_address()->tel : '' }}" name="tel"
                                                    placeholder="number">
                                            </div>
                                            <div class="form-group">
                                                <label for="first-name-vertical">Mobile Number</label>
                                                <input type="text" id="first-name-vertical" class="form-control"
                                                    value="{{ dubai_address() ? dubai_address()->mobile : '' }}"
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-vertical" class="form-control"
                                                value="{{ dubai_address()->email ? dubai_address()->email : '' }}"
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="first-name-vertical" class="form-control" name="address" placeholder="Address">{{ dubai_address() ? dubai_address()->address : '' }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="first-name-vertical">Map Link</label>
                                            <textarea type="text" id="first-name-vertical" class="form-control" name="map" placeholder="Map Link"> {{ dubai_address() ? dubai_address()->map : '' }}</textarea>
                                        </div>
                                    </div>
                                    <button type="submit" class="btn btn-success">Update</button>
                                    </form>
