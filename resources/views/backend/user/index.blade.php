                        ...
                        <div class="col-12">
                           <form action="{{route('admin.users.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required id="first-name-vertical" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Full Name">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" required id="first-name-vertical" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="User email">
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <span>{{ $message }}</span>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-vertical" class="form-control @error('phone') is-invalid @enderror" name="phone" placeholder="User phone">
                                    @error('phone')
                                        <span class="invalid-feedback" role="alert">
                                            <span>{{ $message }}</span>
                                        </span>
                                ...
                                <div class="row">
                                        ...
                                        @foreach ($roles as $role)
                                            <fieldset>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" value="{{$role->name}}" name="roles[]" id="assignAllPermissions{{$role->name}}">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="avatar mr-1 avatar-xl">
                                            <img src="{{asset('backend/app-assets/images/portrait/small/avatar-s-12.jpg')}}" alt="avtar img holder">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" required id="first-name-vertical" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="xxxxxxx">
                                    @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <span>{{ $message }}</span>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" required id="first-name-vertical" class="form-control @error('password_confirmation') is-invalid @enderror" name="password_confirmation" placeholder="xxxxxxx">
