        ...
        <tbody>
            @foreach ($categories as $key => $item)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.car_sub_category.edit', $item->id) }}"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  document.getElementById('delete-form-{{ $item->id }}').submit();"
                                            href="{{ route('admin.car_sub_category.destroy', $item->id) }}"
                                            class="btn btn-danger text-white" data-toggle="modal"
                                            data-target="#colorDelete">Delete</a>
                                        <form id="delete-form-{{ $item->id }}"
                                            action="{{ route('admin.car_sub_category.destroy', $item->id) }}" method="POST"
                                            class="d-none">
                                            @method('DELETE')
                                            @csrf
                                        </form>
