        ...
        <div class="card" style="background-color: #fde4e477">
            ...
            <div class="card-content">
                <div class="card-body" style="position: relative;">
                    <div class="row">
                        <div class="col-12">
                           <form action="{{route('admin.roles.update',$singleRole->id)}}" method="post">
                                @method('PUT')
                                @csrf
                                <div class="form-group">
                                    <label for="first-name-vertical">Role Name</label>
                                    <input type="text" id="first-name-vertical" class="form-control @error('name') is-invalid @enderror" value="{{$singleRole->name}}" name="name" placeholder="Role Name">
                                    @error('name')
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <fieldset>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" {{App\Models\User::roleHasPermission($singleRole,$permissions)?'checked':''}} value="1" name="customCheck" id="assignAllPermissions">
                                        ...
                                        @foreach ($permission_groups as $group)
                                            ...
                                            <div class="row mb-1">
                                                <div class="col-4">
                                                    <fieldset>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" value="{{ $group->group_name}}"  id="assignAllGroupPermissions{{$i}}" onclick="checkPermissionByGroup('role-{{$i}}-management-checkbox',this)" {{App\Models\User::roleHasPermission($singleRole,$permissions)?'checked':''}}>
                                                ...
                                                <div class="col-8 role-{{$i}}-management-checkbox">
                                                    @foreach ($permissions as $permission)
                                                        <fieldset>
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox" name="permissions[]" class="custom-control-input" value="{{$permission->name}}" {{$singleRole->hasPermissionTo($permission->name)? 'checked' :''}}  name="name" id="customCheck{{$permission->id}}">
