        ...
        <div class="col-lg-4 col-md-12">
            <div class="card" style="background-color: #fde4e477">
                <div class="card-header">
                    ...
                    <div class="brand">
                        <div class="brandIcon">
                            <img id="imagePreview" src="{{ asset($brand->image) }}" alt="" srcset="">
                        </div>
                        <div class="brandName">
                            <p>{{ $brand->name }}</p>
                        </div>
                                ...
                                <form action="{{ route('admin.brands.update', $brand->id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="first-name-vertical"
                                            class="form-control @error('name') is-invalid @enderror" value="{{$brand->name}}" name="name"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="brnad_description" class="form-control" id="brnad_description" rows="3">{{$brand->brnad_description}}</textarea>
                                    </div>
