                    ...
                    <div class="row row-cols-1 mt-3 g-2">
                        <div class="col">
                            <div class="card feature-list border-0">
                                <div class="row g-0">
                                    <div class="col-4 p-2">
                                        <img src="{{ asset('images/room_1.jpg') }}" class="img-fluid rounded d-block m-auto w-100"
                        ...
                        <div class="col">
                            <div class="card feature-list border-0">
                                <div class="row g-0">
                                    <div class="col-4 p-2">
                                        <img src="{{ asset('images/room_2.jpg') }}" class="img-fluid rounded d-block m-auto w-100"
                                            alt="..." title="..." style="height: 65px;">
                                    </div>
                                    <div class="col-8">
                                        <div class="card-body p-2">
                        ...
                        <div class="col">
                            <div class="card feature-list border-0">
                                <div class="row g-0">
                                    <div class="col-4 p-2">
                                        <img src="{{ asset('images/room_3.jpg') }}" class="img-fluid rounded d-block m-auto w-100"
                                            alt="..." title="..." style="height: 65px;">
                                    </div>
                                    <div class="col-8">
                                        <div class="card-body p-2">
                        ...
                        <div class="col">
                            <div class="card feature-list border-0">
                                <div class="row g-0">
                                    <div class="col-4 p-2">
                                        <img src="{{ asset('images/room_4.jpg') }}" class="img-fluid rounded d-block m-auto w-100"
                                            alt="..." title="..." style="height: 65px;">
                                    </div>
                                    <div class="col-8">
                                        <div class="card-body p-2">
                        ...
                        <div class="col">
                            <div class="card feature-list border-0">
                                <div class="row g-0">
                                    <div class="col-4 p-2">
                                        <img src="{{ asset('images/room_5.jpg') }}" class="img-fluid rounded d-block m-auto w-100"
                                            alt="..." title="..." style="height: 65px;">
                                    </div>
                                    <div class="col-8">
                                        <div class="card-body p-2">
                        ...
                        <div class="col">
                            <div class="card feature-list border-0">
                                <div class="row g-0">
                                    <div class="col-4 p-2">
                                        <img src="{{ asset('images/room_6.jpg') }}" class="img-fluid rounded d-block m-auto w-100"
                                            alt="..." title="..." style="height: 65px;">
                                    </div>
                                    <div class="col-8">
                                        <div class="card-body p-2">
                                        ...
                                        <div id="carouselBusinessList_1"
                                            ...
                                            <div class="carousel-inner rounded overflow-hidden z-1">
                                                <div class="carousel-item active">
                                                    <img src="{{ asset('images/room_1.jpg') }}" class="img-fluid d-block w-100 rounded"
                                                        alt="..." title="..." style="height: 330px;">
                                                </div>
                                                <div class="carousel-item">
                                                    <img src="{{ asset('images/room_2.jpg') }}" class="img-fluid d-block w-100 rounded"
                                                        alt="..." title="..." style="height: 330px;">
                                                </div>
                                                <div class="carousel-item">
                                                    <img src="{{ asset('images/room_3.jpg') }}" class="img-fluid d-block w-100 rounded"
                                                        alt="..." title="..." style="height: 330px;">
                                                </div>
                                                <div class="carousel-item">
                                                    <img src="{{ asset('images/room_4.jpg') }}" class="img-fluid d-block w-100 rounded"
                                                        alt="..." title="..." style="height: 330px;">
                                                </div>
                                                <div class="carousel-item">
                                                    <img src="{{ asset('images/room_5.jpg') }}" class="img-fluid d-block w-100 rounded"
                                                        alt="..." title="..." style="height: 330px;">
                                                </div>
                                                <div class="carousel-item">
                                                    <img src="{{ asset('images/room_6.jpg') }}" class="img-fluid d-block w-100 rounded"
                                                        alt="..." title="..." style="height: 330px;">
                                                </div>
                                                <div class="carousel-item">
                                                    <img src="{{ asset('images/room_7.jpg') }}" class="img-fluid d-block w-100 rounded"
                                                        alt="..." title="..." style="height: 330px;">
                                                </div>
                                                <div class="carousel-item">
                                                    <img src="{{ asset('images/room_8.jpg') }}" class="img-fluid d-block w-100 rounded"
                                                        alt="..." title="..." style="height: 330px;">
                                                </div>
                                            </div>
                                ...
                                <div class="row g-0">
                                    <div class="col-lg-6 p-2">
                                        <div id="carouselBusinessList" class="carousel slide position-relative">
                                            ...
                                            <div class="carousel-inner rounded overflow-hidden z-1">
                                                <div class="carousel-item active">
                                                    <img src="{{ asset('images/room_5.jpg') }}"
                                                ...
                                                <div class="carousel-item">
                                                    <img src="{{ asset('images/room_3.jpg') }}"
                                                        class="img-fluid d-block w-100 rounded" alt="..."
                                                        title="..." style="height: 330px;">
                                                </div>
                                                <div class="carousel-item">
                                                    <img src="{{ asset('images/room_4.jpg') }}"
                                                        class="img-fluid d-block w-100 rounded" alt="..."
                                                        title="..." style="height: 330px;">
                                                </div>
                                                <div class="carousel-item">
                                                ...
                                                <div class="carousel-item">
                                                    <img src="{{ asset('images/room_6.jpg') }}"
                                                        class="img-fluid d-block w-100 rounded" alt="..."
                                                        title="..." style="height: 330px;">
                                                </div>
                                                <div class="carousel-item">
                                                    <img src="{{ asset('images/room_7.jpg') }}"
                                                        class="img-fluid d-block w-100 rounded" alt="..."
                                                        title="..." style="height: 330px;">
                                                </div>
                                                <div class="carousel-item">
                                                    <img src="{{ asset('images/room_8.jpg') }}"
                                                        class="img-fluid d-block w-100 rounded" alt="..."
                                                        title="..." style="height: 330px;">
                                                </div>
                                            </div>
