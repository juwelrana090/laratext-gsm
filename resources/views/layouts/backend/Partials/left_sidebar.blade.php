...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="{{ $carSetupActive ? 'sidebar-group-active open' : '' }}  nav-item">
                ...
                <ul class="menu-content">
                    ...
                    <li class="{{ Route::is('blogs.index') ? 'active' : '' }}">
                        <a href="{{ route('blogs.index') }}"><i class="feather icon-circle"></i><span
            ...
            <li class=" {{ Route::is('admin.frontend.about_us') ? 'active' : '' }} nav-item"><a
                    href="{{ route('admin.frontend.about_us') }}"><i class="feather icon-zap"></i><span
