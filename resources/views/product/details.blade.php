                    ...
                    <div id="carouselBusinessList_1" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner rounded overflow-hidden z-1 mt-4">
                            <div class="carousel-item active p-3">
                                <img src="{{ asset('images/product_1.png') }}" class="img-fluid d-block w-100 rounded" alt="..."
                                    title="..." style="height: 300px;">
                            </div>
                            <div class="carousel-item p-3">
                                <img src="{{ asset('images/product_2.png') }}" class="img-fluid d-block w-100 rounded" alt="..."
                                    title="..." style="height: 300px;">
                            </div>
                            <div class="carousel-item p-3">
                                <img src="{{ asset('images/product_3.png') }}" class="img-fluid d-block w-100 rounded" alt="..."
                                    title="..." style="height: 300px;">
                            </div>
                            <div class="carousel-item p-3">
                                <img src="{{ asset('images/product_4.png') }}" class="img-fluid d-block w-100 rounded" alt="..."
                                    title="..." style="height: 300px;">
                            </div>
                            <div class="carousel-item p-3">
                                <img src="{{ asset('images/product_5.png') }}" class="img-fluid d-block w-100 rounded" alt="..."
                                    title="..." style="height: 300px;">
                            </div>
                            <div class="carousel-item p-3">
                                <img src="{{ asset('images/product_6.png') }}" class="img-fluid d-block w-100 rounded" alt="..."
                                    title="..." style="height: 300px;">
                            </div>
                            <div class="carousel-item p-3">
                                <img src="{{ asset('images/product_7.png') }}" class="img-fluid d-block w-100 rounded" alt="..."
                                    title="..." style="height: 300px;">
                            </div>
                            <div class="carousel-item p-3">
                                <img src="{{ asset('images/product_8.png') }}" class="img-fluid d-block w-100 rounded" alt="..."
                                    title="..." style="height: 300px;">
                            </div>
                            <div class="carousel-item p-3">
                                <img src="{{ asset('images/product_9.png') }}" class="img-fluid d-block w-100 rounded" alt="..."
                                    title="..." style="height: 300px;">
                            </div>
                            <div class="carousel-item p-3">
                                <img src="{{ asset('images/product_10.png') }}" class="img-fluid d-block w-100 rounded" alt="..."
                                    title="..." style="height: 300px;">
                            </div>
                        </div>
